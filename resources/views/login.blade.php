            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                    <div class="relative">
                        ...
                        <input autocomplete="off" type="text" name="username" id="username"  class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="username" required>
                    </div>
                    <div class="relative">
